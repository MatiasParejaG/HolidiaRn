export const PROPERTIES = [
  {
    ...
    description:
      'Ven a Playa Coronado y disfruta con tu familia o un grupo de amigos en esta casa privada dentro de una comunidad de playa cerrada. La casa tiene un diseño moderno.',
    price_per_night: 111,
    ...
    address: '123 Camino de la Playa',
    city: 'París',
    country: 'EE. UU.',
    amenities: 'WiFi, Cocina, Estacionamiento gratuito',
    capacity: 4,
    longitude: -118.6923,
    latitude: 34.0381,
  ...
  },
  {
    ...
    city: 'París',
    country: 'Francia',
    amenities: 'Piscina, Cocina, Estacionamiento gratuito, WiFi',
    capacity: 1,
    longitude: -120.6923,
    latitude: 30.0381,
    latitude_delta: 0.0421,
  ...
  },
  {
    ...
    name: 'Cabaña Frente al Mar',
    description: 'Una hermosa cabaña con vistas al océano',
    price_per_night: 200,
    owner_id: 'user_c71adf0f-3fbd-4b37-8c4c-5b926d82666b',
